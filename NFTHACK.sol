...
contract KitaJagaNFT is ERC721, ERC721URIStorage, Ownable {
    ...
    // string public uri = "bafyreidyd4pzcpvcjt6xk3tt3z37f4fkcit63l6xg5y46aljof6ea3ehbu/metadata.json";

    string public uri =
        "bafyreibouldt6ryru4xepjcjtojysyexbzvzu5ownmmnr6a4qhtat4clna/metadata.json";

    uint256 public totalSupplyNFT;
    int96 public newFlowRate;
    ...
    function setFlowRate(int96 setFlow) external onlyOwner {
        newFlowRate = setFlow;
    }

    function _issueNFT() internal {
        //require(receiver != address(this), "Issue to a new address");
        require(newFlowRate > 0, "flowRate must be positive!");

        flowRates[nextId] = newFlowRate;
        emit NFTIssued(nextId, msg.sender, flowRates[nextId]);
